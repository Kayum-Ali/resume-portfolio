    ...
    return (
        <div className="bg-[#F2F4F7]">
            <div className="container mx-auto">
                <div className="flex items-center justify-center gap-6 py-16 px-12">
                    <div>
                    ...
                    <div className="space-y-8">
                        ...
                        <p className="w-2/3  font-medium text-xl text-[#AEB6C4]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis lacus nunc, posuere in justo vulputate, bibendum sodales </p>
